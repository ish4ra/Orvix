...
class _TvSideNavigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 92,
      decoration: const BoxDecoration(
        color: Color(0xF2070A08),
        border: Border(
          right: BorderSide(color: Color(0xFF142016), width: 1),
        ),
      ),
      child: Column(
        children: [
...
class _TvOrvixMark extends StatelessWidget {
  const _TvOrvixMark();
          ...
          child: Column(
            ...
            children: [
              Icon(
                widget.icon,
                size: 21,
                color: active ? primary : const Color(0xFF8C978E),
              ),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: active ? primary : const Color(0xFF7E8980),
                ),
              ),
            ],
          ),
