...
class AiSinhalaSubtitleService {
  ...
  static Future<_EmbeddedSubtitleSource?> _fetchEmbeddedEnglishSubtitle(
    ...
    // stream-server v0.1.8's embedded subtitle extractor targets the largest
    // video file in a torrent. Guard multi-file/season-pack playback so we
    // never translate subtitles from a different episode.
