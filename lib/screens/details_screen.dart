    ...
    if (useLocalMediaBridge) {
      ...
      if (Platform.isWindows) {
        ...
        try {
          ...
          // Keep cloud playback usable if the native proxy cannot produce real
          // media bytes for this signed URL. Fall back before the player opens
          // instead of leaving the user on a 0:00 black buffering screen.
          if (mounted) {
            setState(() {
              _status =
